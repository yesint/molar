...
pub type gmx_EnumerationIterator_IntegerType = std_underlying_type_t;
#[doc = "! Convenience alias."]
...
pub type gmx_EnumerationArray_reverse_iterator<DataType> =
    std_reverse_iterator<gmx_EnumerationArray_iterator<DataType>>;
pub type gmx_EnumerationArray_const_reverse_iterator<DataType> =
    std_reverse_iterator<gmx_EnumerationArray_const_iterator<DataType>>;
#[doc = "@{*/\n//! Pointers (unchecked)"]
...
pub type gmx_PaddedVector_storage_type = std_vector;
...
pub struct t_expanded {
    ...
    pub init_lambda_weights: std_vector,
}
#[repr(C)]
pub struct t_rotgrp {
...
pub struct t_inputrec {
    ...
    pub internalParameters: std_unique_ptr,
}
extern "C" {
...
pub struct t_state {
    ...
    pub cg_gl: std_vector,
    #[doc = "!< The COM of the previous step of each pull group"]
    pub pull_com_prev_step: std_vector,
}
extern "C" {
...
extern "C" {
    #[link_name = "\u{1}_Z8read_tprPKcP10t_topologyP7t_stateP10t_inputrec"]
    pub fn read_tpr(
