...
impl SourceParallel<()> {    
    ...
    pub fn new_mut (
        topology: impl TryInto<Topology<MutableParallel>, Error=SelectionError>,
        state: impl TryInto<State<MutableParallel>, Error=SelectionError>,
    ...
    pub fn new (
        topology: impl TryInto<Topology<ImmutableParallel>, Error=SelectionError>,
        state: impl TryInto<State<ImmutableParallel>, Error=SelectionError>,
...
impl<K: ParallelSel> SourceParallel<K> {
    ...
    pub fn get_sel(&self, i: usize) -> Result<&Sel<K>, SelectionError> {
        self.selections.get(i).ok_or_else(|| SelectionError::OutOfBounds(i, self.state.num_coords()))
    }
